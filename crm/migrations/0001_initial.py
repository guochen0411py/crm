# Generated by Django 2.1.5 on 2019-01-11 03:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=32, verbose_name='作业名称')),
                ('create_date', models.DateField(auto_now_add=True, verbose_name='创建时间')),
                ('hand_in_date', models.DateField(verbose_name='最晚上交时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.FileField(upload_to='student_work/', verbose_name='作业内容')),
                ('create_date', models.DateField(auto_now_add=True, verbose_name='提交时间')),
                ('score', models.IntegerField(verbose_name='作业成绩')),
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.HomeWork', verbose_name='作业名称')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentRecord',
        ...
        migrations.AddField(
            model_name='scorerecord',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.UserInfo', verbose_name='执行人'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='confirm_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirms', to='crm.UserInfo', verbose_name='审批人'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='consultant',
        ...
        migrations.AddField(
            ...
            name='teacher',
            field=models.ForeignKey(limit_choices_to={'depart__title': '教质部'}, on_delete=django.db.models.deletion.CASCADE, to='crm.UserInfo', verbose_name='批改老师'),
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(blank=True, limit_choices_to={'depart__title': '销售部'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consultant', to='crm.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
        ...
        migrations.AddField(
            ...
            name='class_teacher',
            field=models.ForeignKey(limit_choices_to={'depart__title': '教质部'}, on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='crm.UserInfo', verbose_name='班主任'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
